      ...
      <div class="card card-default">
        <div class="card-heading">
          <center>
            ...
            <div class="card-body" >
              <form  action="{{route('registroPlanesMSU')}}" method="post" id="planes" >
                @csrf
        ...
        <div class="col-xs-12 col-md-12">
          <div class="form-group two-fields">
            <div class="input-group">
              ...
              <span class="input-group-addon">        </span>
              <div class="col-sm-6">
               <select required id="id_opcion_educativa" title="option" name="id_opcion_educativa" class="form-control" >@foreach($oferta as $o)<option id="opciones" class="form-control"  value="{{$o->id_opcion_educativa}}">{{$o->nombre_opcion_educativa}}</option>@endforeach
    ...
    <div class="col-xs-12 col-md-12">
      <div class="form-group two-fields">
        <div class="input-group">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" placeholder="Ej. FEB-JUN 2020" name="vigencia" id="vigencia" onkeyup="javascript:this.value=this.value.toUpperCase();" required maxlength="25" value="{{old('vigencia')}}">
              ...
              <div class="form-group two-fields">
                <div class="input-group">
                  ...
                  <div class="col-sm-offset-2 col-sm-12">
                    ...
                    <input type="text" class="form-control"  placeholder="Calificación Mínima Aprobatoria" name="calif_aprobatoria" id="calif_aprobatoria" value="{{old('calif_aprobatoria')}}" required maxlength="3" >
