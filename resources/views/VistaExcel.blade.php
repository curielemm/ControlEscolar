...
<html>
 ...
 <body>
  <div class="container" class="bg-black" style=" background: white ">
   <br />
   <h3 align="center">Datos Excel</h3>
   <br />
   <form id="upload_csv" method="post" enctype="multipart/form-data" class="bg-black" >
    <div class="col-md-3">
     <br />
     <label>Selecciona archivo CSV </label>
                ...
                <div class="col-md-5">
                    <input type="submit" name="upload" id="upload" value="Cargar" style="margin-top:10px;" class="btn btn-info" />
                </div>
