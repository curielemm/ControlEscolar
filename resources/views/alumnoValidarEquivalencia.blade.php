@extends('layouts.app')
<title>Validar Alumno Equivalencia</title>
...
<div class="row">
    <div class="col-md-12 offset-md-12">
        <div class="card card">
            ...
            <div class="card-body">
                <form action="{{ route('validadoEquivalencias')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Folio Equivalencia:</label>
                        <div class="col-sm-8">
                            <input type="text" readonly class="form-control-plaintext" maxlength="10" class="form-control" id="telefono" name="telefono" value="{{$alumno->folio_equivalencia}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    @if($alumno->certificado_parcial == 1)
                                    <input type="checkbox" class="form-check-input" id="certificado_parcial" name="certificado_parcial" value="1" checked>Certificado Parcial
                                    @endif
                                    @if($alumno->certificado_parcial != 1)
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    @if($alumno->equivalencia == 1)
                                    <input type="checkbox" class="form-check-input" id="equivalencia" name="equivalencia" value="1" checked> Equivalencia
                                    @endif
                                    @if($alumno->equivalencia != 1)
                                    <input type="checkbox" class="form-check-input" id="equivalencia" name="equivalencia" value="1">Equivalencia
                                    @endif
                                </label>
                            </div>
                            ...
                            <h5 class="text-center">Calificaciones de Asignaturas Equivalentes</h5>
                            <div class="table-wrapper-scroll-y my-custom-scrollbar">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($calificaciones as $asignatura)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$asignatura->fk_clave_asignatura}}</td>
                    ...
                    <center>
                        <div class="form-group">
                            <div class="col-sm-10">
                                <button type="submit" name="validar" id="validar" class="btn btn-success"><span><i class="fa fa-check" aria-hidden="true"></i>
                                        Validar</span></button>
                            </div>
                        </div>
                        <div class="form-group">
