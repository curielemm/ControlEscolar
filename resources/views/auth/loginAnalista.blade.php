...
<title>Inicio de Sesión Analista</title>
@section('content')
    ...
    <div class="col-md-4 offset-md-4">
        <div class="card card-default border-dark">
            <div class="card-heading text-center">
                <h3 class="card-title">Inicio de Sesión Analista</h3>
            ...
            <div class="card-body">
                ...
                <div class="col-md-6 offset-md-4"> <a href="/registroAnalista">Registrarme</a>
                </div>
