...
<title>Registro de Analista</title>
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Registro de Analista') }}</div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6 offset-md-4"> <a href="/loginAnalista">Prefiero Iniciar Sesion</a>
                    </div>
                </div>
            </div>
        </div>
