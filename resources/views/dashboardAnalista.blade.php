  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Analista <sup></sup></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.html">
          ...
          <span>Panel Analista de {{auth()->user()->nombre_usuario}} {{auth()->user()->apellido_paterno}} {{auth()->user()->apellido_materno}} </span></a>
      </li>
      ...
      <!--li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">Registrar Usuario</a>
            <a class="collapse-item" href="/listarUsuario">Listar Usuarios No Autorizados</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h1 class="h3 mb-0 text-gray-800">Panel de Control de Analista</h1>
          <!-- Topbar Search -->
            ...
            <div class="row">
              ...
              <div class="col-lg-6 mb-4">
                <div class="card" style="width: 15rem;">
                  <img class="card-img-top" src="../img/51.png" width="60" height="200" alt="Card image cap">
                  <div class="card-body">
                    <p class="card-text">Ver Mis Instituciones Asignadas por parte de la CGEMSySCyT </p>
                  </div>
                  <a href="misInstituciones" class="btn btn-success">Ver Mis Instituciones</a>
                </div>
              </div>
              ...
              <!--div class="col-lg-6 mb-4">
                <div class="card" style="width: 15rem;">
                  <img class="card-img-top" src="../img/18.png" width="50" height="225" alt="Card image cap">
                  <div class="card-body">
                    <p class="card-text">Generación de Datos Estadísticos</p>
                  </div>
