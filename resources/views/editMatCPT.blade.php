    ...
    <div class="col-md-7 offset-md-2">
        <div class="card card-default">
            <div class="card-heading">
              <center>
                <h2>EDICIÓN DE ASIGNATURAS</h2>
                <center>
            </div>


            <div class="card-body" >
                <form   method="post" action="{{ route('updateMatCPT',[$uno->clave_asignatura,$plan[0]['rvoe'], $escuela[0]['clave_cct'] ])}}" >
                {{csrf_field()}}
   ...
   <!--<div class="container">
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group two-fields">
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control"  placeholder="Clave de Asignatura" name="clave_asignatura" id="clave_asignatura" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$uno->clave_asignatura}}" readonly maxlength="10">
               ...
               <div class="container">
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                          ...
                          <input type="text" class="form-control"  placeholder="Nombre de la Asignatura" name="nombre_asignatura" id="nombre_asignatura" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$uno->nombre_asignatura}}" required maxlength="30">
           ...
           <div class="container">
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                         ...
                         <select name="tipo_asignatura" id="tipo_asignatura" class="form-control" readonly>
                              <option value="SELECCIONE"  selected>SELECCIONE UNA OPCIÓN</option>
                              <option value="tronco_comun">TRONCO COMÚN</option>
                              <option value="especialidad">ESPECIALIDAD</option>
                              <option value="{{$uno->tipo_asignatura}}" hidden selected>{{$uno->tipo_asignatura}}</option>
                            </select>
                      </div>
                    </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group two-fields">
                            ...
                            <input type="text"  class="form-control" name="no_periodo" id="no_periodo"value="{{$uno->no_periodo}}" placeholder="Numero de Periodo (1-13)">
                          ...
                          <span class="input-group-addon"></span>
                            ...
                            <select name="semestre_cuatrimestre" id="semestre_cuatrimestre" class="form-control" readonly>
                              <option value="SELECCIONE">SELECCIONE UNA OPCIÓN</option>
                              <option value="SEMESTRE">SEMESTRE</option>
                              <option value="CUATRIMESTRE">CUATRIMESTRE</option>
                              <option value="TRIMESTRE">TRIMESTRE</option>
                              <option value="BIMESTRE">BIMESTRE</option>
                              <option value="{{$uno->semestre_cuatrimestre}}" hidden selected>{{$uno->semestre_cuatrimestre}}</option>
                            </select>
    ...
    <div class="container">
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group two-fields">
                            ...
                            <input type="text"  class="form-control" name="seriazion" id="seriazion"value="{{$uno->seriazion}}" placeholder="Clave de Asignatura o N/A" readonly>

                         
                           </div>
                                         <span class="input-group-addon"></span>
                            <div class="col-sm-6">
                              <input type="text" class="form-control"  placeholder="No. Creditos" name="no_creditos" id="no_creditos" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$uno->no_creditos}}" readonly maxlength="2">
           ...
           <div class="container">
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group two-fields">
                            ...
                            <input type="text"  class="form-control" name="clave_seriacion" id="clave_seriacion"value="{{$uno->clave_seriacion}}" placeholder="Clave de Seriazión" readonly>
                        
                           </div>
                            <span class="input-group-addon"></span>
                            <div class="col-sm-6">

                              <input type="text" class="form-control"  placeholder="No. de Parciales" name="no_parciales" id="no_parciales" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$uno->no_parciales}}" readonly maxlength="2">
                    ...
                    <div class="col-sm-offset-2 col-sm-12">
                        <button type="submit" class="btn btn-primary btn-block">Editar Asignatura CPT</button>
                    </div>
