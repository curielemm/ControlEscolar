...
<div class="row" >
    <div class="col-md-7 offset-md-2">
        <div class="card card-default">
            ...
            <div class="card-body" >
                <form   method="post" action="{{ route('updateMatMSU',[$uno->clave_asignatura,$plan[0]['rvoe'], $escuela[0]['clave_cct'] ])}}" >
                {{csrf_field()}}
   ...
   <!--<div class="container">
    ...
    <div class="container">
           ...
           <div class="container">
                    ...
                    <div class="col-sm-offset-2 col-sm-12">
                        <button type="submit" class="btn btn-primary btn-block">Editar Asignatura MSU</button>
                    </div>
