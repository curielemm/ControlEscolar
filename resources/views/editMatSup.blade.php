...
<div class="row" >
    <div class="col-md-7 offset-md-2">
        <div class="card card-default">
            ...
            <div class="card-body" >
                <form   method="post" action="{{ route('updateMatSup',[$uno->clave_asignatura,$plan[0]['rvoe'], $escuela[0]['clave_cct'] ])}}" >
                {{csrf_field()}}
   ...
   <div class="container">
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group two-fields">
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control"  placeholder="Clave de Asignatura" name="clave_asignatura" id="clave_asignatura" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$uno->clave_asignatura}}" readonly>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-md-12">
                          <div class="form-group two-fields">
                            ...
                            <input type="text"  class="form-control" name="no_periodo" id="no_periodo"value="{{$uno->no_periodo}}" placeholder="Numero de Periodo (1-13)" readonly>
    ...
    <div class="container">
           ...
           <div class="container">
                    ...
                    <div class="col-sm-offset-2 col-sm-12">
                        <button type="submit" class="btn btn-primary btn-block">Editar Asignatura SUP</button>
                    </div>
