    ...
    <div class="col-md-8 offset-md-2">
        <div class="card card-default">
            <div class="card-heading">
                <center>
                    <h4>MODIFIQUE LOS DATOS DE LA INSTITUCIÓN MEDIA SUPERIOR</h4>
                    <center>
            </div>
                            ...
                            <div class="col-xs-12 col-md-12">
                                <div class="form-group two-fields">
                                    <div class="input-group">
                                        ...
                                        <div class="col-sm-offset-2 col-sm-12">
                                            <div>
                                                <input type="file" class="form-control" name="periodico_oficial" value="{{$uno->periodico_oficial}}">
                                ...
                                <div class="form-group two-fields ">
                                    <div class="input-group">
                                        ...
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="Pagina Web" name="pagina_web" value="{{$uno->pagina_web}}" required>
