@extends('layouts.app')
<title>Editar Plan de Estudios Actualizado</title>
@section('content')
...
<div class="row">
    <div class="col-md-7 offset-md-2">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form action=" {{ route('updatePlanActu',[$uno->rvoe,$escuela[0]['clave_cct'],$uno->vigencia])}}" method="post" id="planes" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="vigencia" id="vigencia" class="form-control">
                                                ...
                                                <option value="{{$uno->vigencia}}" hidden selected>{{$uno->vigencia}}</option>
                                            </select>{!!$errors->first('vigencia','<small class="text-danger">:message</small><br>')!!}
                            ...
                            <div class="col-xs-12 col-md-12">
                                <div class="form-group two-fields">
                                    <div class="input-group">
                                        ...
                                        <label class="control-label col-sm-6">Ver Plan: @if($uno->archivo != null)<a href="{{Storage::url($uno->archivo)}}" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a>@endif
                                        @if($uno->archivo ==null)<i class="fa fa-eye-slash" aria-hidden="true"></i> @endif
                                        </label>
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <input type="file" accept=".pdf" class="form-control" name="archivo" id="archivo">
                                            <input type="hidden" name="anterior" id="anterior" class="form-control" value="{{$uno->archivo}}">
                                        </div>
