    ...
    <div class="col-md-7 offset-md-2">
      <div class="card card-default">
        <div class="card-heading">
          <center>
            <h2>EDICIÓN PLAN DE ESTUDIOS</h2>
            <h2>"CAPACITACIÓN PARA EL TRABAJO"</h2>
            <center>
            </div>

            <div class="card-body" >
              <form  action="{{ route('updatePlanCPT',[$uno->rvoe,$escuela[0]['clave_cct']])}}" method="post" id="planes" >
                @csrf
                  ...
                  <div class="form-group two-fields">
                    <div class="input-group">
                     <div class="col-sm-6">
                      ...
                      <input type="text"   class="form-control" id="rvoe" name="rvoe" placeholder="RVOE" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{$uno->rvoe}}" readonly maxlength="15">
                ...
                <div class="form-group two-fields">
                  <div class="input-group">
                   <div class="col-sm-offset-2 col-sm-12">
                    ...
                    <label class="control-label col-sm-10">Fecha de Publicación en el Periodico Oficial:</label>
            ...
            <div class="col-xs-12 col-md-12">
              <div class="form-group two-fields">
                <div class="input-group">
                 ...
                 <div class="col-sm-6">
                  <select id="id_tipo_nivel" title="option" name="id_tipo_nivel" class="form-control" readonly>@foreach($tipo as $t)<option id="opciones" class="form-control"  value="{{$t->id_tipo_nivel}}">{{$t->nombre_tipo_nivel}}</option>@endforeach
                ...
                <span class="input-group-addon">        </span>
                <div class="col-sm-6">
                 <select id="id_nivel_educativo" title="option" name="id_nivel_educativo" class="form-control" readonly >@foreach($nivel as $n)<option id="opciones" class="form-control"  value="{{$n->id_nivel_educativo}}">{{$n->nombre_nivel_educativo}}</option>@endforeach
        ...
        <div class="col-xs-12 col-md-12">
          <div class="form-group two-fields">
            <div class="input-group">
              ...
              <div class="col-sm-6">
                <select id="id_modalidad" title="option" name="id_modalidad" class="form-control"  readonly>@foreach($modal as $m)<option id="opciones" class="form-control"  value="{{$m->id_modalidad}}">{{$m->nombre_modalidad}}</option>@endforeach
              ...
              <span class="input-group-addon">        </span>
              <div class="col-sm-6">
               <select id="id_opcion_educativa" title="option" name="id_opcion_educativa" class="form-control" readonly >@foreach($oferta as $o)<option id="opciones" class="form-control"  value="{{$o->id_opcion_educativa}}">{{$o->nombre_opcion_educativa}}</option>@endforeach
      ...
      <div class="col-xs-12 col-md-12">
        <div class="form-group two-fields">
          <div class="input-group">
            ...
            <div class="col-sm-6">
             <select id="id_duracion" title="option" name="id_duracion" class="form-control" readonly>@foreach($duracion as $d)<option id="opciones" class="form-control"  value="{{$d->id_duracion}}">{{$d->nombre_duracion}}</option>@endforeach
          ...
          <span class="input-group-addon">        </span>
          <div class="col-sm-6">
           <select id="id_turno" title="option" name="id_turno" class="form-control" readonly>@foreach($turno as $t)<option id="opciones" class="form-control"  value="{{$t->id_turno}}">{{$t->nombre_turno}}</option>@endforeach
    ...
    <div class="col-xs-12 col-md-12">
      <div class="form-group two-fields">
        <div class="input-group">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" placeholder="Ej. FEB-JUN 2020" name="vigencia" id="vigencia" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="25" value="{{$uno->vigencia}}" readonly>
                    ...
                    <div class="form-group two-fields">
                      <div class="input-group">
                        ...
                        <div class="col-sm-6">
                         ...
                         <input type="text"  class="form-control" name="calif_min" id="calif_min" value="{{$uno->calif_min}}" placeholder="Calificación Mínima" readonly>

                       </div>
                       <span class="input-group-addon"></span>
                       <div class="col-sm-6">
                        <input type="text"  class="form-control" name="calif_maxima" id="calif_maxima" value="{{$uno->calif_maxima}}" placeholder="Calificación Máxima" readonly>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-12">
              <div class="form-group two-fields">
                <div class="input-group">
                  <label class="control-label col-sm-0" id="asterisco">*</label>
                  <label class="control-label col-sm-11">Calificación Minima Aprobatoria:</label>

                  <div class="col-sm-offset-2 col-sm-12">

                    <input type="text" class="form-control"  placeholder="Calificación Minima Aprobatoria" name="calif_aprobatoria" id="calif_aprobatoria" value="{{$uno->calif_aprobatoria}}" readonly maxlength="3" >
    ...
    <div class="col-xs-12 col-md-12">
      <div class="form-group two-fields">
        <div class="input-group">
         <div class="col-sm-offset-2 col-sm-12">
           <div>
            <button type="submit" class="btn btn-primary btn-block">Editar Plan Estudio CPT</button>
          </div>
        </div>
      </div>
    </div>
