      ...
      <div class="card card-default">
        <div class="card-heading">
          <center>
            ...
            <h2>"MEDIA SUPERIOR"</h2>
            <center>
            </div>

            <div class="card-body" >
              <form  action="{{ route('updatePlanMSU',[$uno->rvoe,$escuela[0]['clave_cct']])}}" method="post" id="planes" >
                @csrf
                    ...
                    <div class="form-group two-fields">
                      <div class="input-group">
                        ...
                        <div class="col-sm-6">
                         ...
                         <input type="text"  class="form-control" name="calif_min" id="calif_min" value="{{$uno->calif_min}}" placeholder="Calificación Minima" readonly>

                       </div>
                       <span class="input-group-addon"></span>
                       <div class="col-sm-6">
                        <input type="text"  class="form-control" name="calif_maxima" id="calif_maxima" value="{{$uno->calif_maxima}}" placeholder="Calificación Maxima" readonly>
              ...
              <div class="form-group two-fields">
                <div class="input-group">
                  ...
                  <div class="col-sm-offset-2 col-sm-12">
                    ...
                    <input type="text" class="form-control"  placeholder="Calificación Mínima Aprobatoria" name="calif_aprobatoria" id="calif_aprobatoria" value="{{$uno->calif_aprobatoria}}"  maxlength="3" readonly>
    ...
    <div class="col-xs-12 col-md-12">
      <div class="form-group two-fields">
        <div class="input-group">
         <div class="col-sm-offset-2 col-sm-12">
           <div>
            <button type="submit" class="btn btn-primary btn-block">Editar Plan Estudio MSU</button>
          </div>
        </div>
      </div>
    </div>
