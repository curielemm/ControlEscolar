@extends('layouts.app')
<title>Validar Inscripción Equivalencia</title>
...
<div class="row">
    <div class="col-md-12 offset-md-12">
        <div class="card card-default">
            ...
            <h4 class="text-center">LISTA DE ALUMNOS DEL GRUPO "{{$grupo->nombre_grupo}}" PARA VALIDAR INSCRIPCIÓN DE EQUIVALENCIAS </h4>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="table-success">@endif
                                <form action="{{route('validarAlumnoEquivalencia',[$alumno->curp,$rvoe,$datos->vigencia,$institucion->clave_cct])}}" method="get">
                                    {{csrf_field()}}
