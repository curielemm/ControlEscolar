@extends('layouts.app')
<title>Lista de Grupos Analista</title>
...
<div class="row">
    <div class="col-md-12 offset-md-12">
        <div class="card card-default">
            ...
            <h3 class="text-center">GRUPOS DE EQUIVALENCIA "@if($datos->id_tipo_nivel==1){{$datos->nombre_plan}} {{$datos->vigencia}} @endif
            ...
            <div class="card-header">
                Selecciona una opción para Validar alumnos de Equivalencia
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group row">
                                    <div class="col-md-5">
                                        <form action="{{ route('validarInscripcionEquivalencia',[encrypt($grupo->clave_grupo), encrypt($datos->rvoe), encrypt($datos->vigencia), encrypt($institucion->clave_cct)])}}" method="get">
                                            <button data-title="Validar alumnos del Grupo con Equivalencias" class="btn btn-outline-success"><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </div>
                                    <div class="col-md-5">
                                        <form id="acuse{{$loop->iteration}}" name="acuse{{$loop->iteration}}" action="{{route('acuseInscripcionEqu',[$grupo->clave_grupo,$datos->rvoe,$institucion->clave_cct,$datos->vigencia])}}" method="get">
