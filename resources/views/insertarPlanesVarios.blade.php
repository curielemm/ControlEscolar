  ...
  <div class="col-md-7 offset-md-2">
    <div class="card card-default">
      <div class="card-heading">
        <center>
          <h2>REGISTRO DE PLANES DE ESTUDIOS SUPERIOR</h2>
          <center>
      </div>

      <div class="card-body">
        <form action="{{ route('registroPlanesVarios')}}" method="post" id="planes" enctype="multipart/form-data">
          @csrf
                ...
                <div class="form-group two-fields">
                  <div class="input-group">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control" name="clave_cct2" id="clave_cct2" value="{{old('clave_cct2')}}" readonly>

                    </div>
                    <span class="input-group-addon"></span>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" placeholder="Clave de Carrera DGP" name="clave_dgp" id="clave_dgp" onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{old('clave_dgp')}}" required maxlength="12">
                ...
                <div class="form-group two-fields">
                  <div class="input-group">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="number" min="0" class="form-control" name="calif_min" id="calif_min" value="{{old('calif_min')}}" placeholder="Calificación Mínima" required>

                    </div>
                    <span class="input-group-addon"></span>
                    <div class="col-sm-6">
                      <input type="number" min="0" class="form-control" name="calif_maxima" id="calif_maxima" value="{{old('calif_maxima')}}" placeholder="Calificación Máxima" required>
                ...
                <div class="form-group two-fields">
                  <div class="input-group">
                    ...
                    <div class="col-sm-offset-2 col-sm-12">
                      ...
                      <input type="number" min="0" class="form-control" placeholder="Calificación Mínima Aprobatoria" name="calif_aprobatoria" id="calif_aprobatoria" value="{{old('calif_aprobatoria')}}" required maxlength="10">
                  ...
                  <div class="input-group">
                    ...
                    <div class="col-sm-offset-2 col-sm-12">
                      ...
                      <p id="charNum" align="right">
                        <font size="2">45 caracteres restantes</font>
                      </p>
                ...
                <div class="form-group two-fields">
                  <div class="input-group">
                    ...
                    <div class="col-sm-offset-2 col-sm-12">
                      ...
                      {!!$errors->first('archivo','<small class="text-danger">:message</small><br>')!!}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group two-fields">
                  <div class="input-group">
                    ...
                    <div class="col-sm-offset-2 col-sm-12">
                      ...
                      {!!$errors->first('dof','<small class="text-danger">:message</small><br>')!!}
                    </div>
                  </div>
                </div>
              </div>
...
<script>
  $(document).on('change', '#nombre_institucion', function() {
    ...
    console.log(value);
    $('#clave_cct2').val(value); //le agregamos el valor al input (notese que el input debe tener un ID para que le caiga el valor)
    console.log($('#clave_cct2'));
  });
</script>
