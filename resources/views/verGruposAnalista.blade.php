                ...
                <table class="table table-light table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a data-title="Ver los alumnos del grupo" href="{{route('listarAlumnosAnalista',$grupo->clave_grupo)}}">{{$grupo->clave_grupo}}</a>
                            ...
                            <td>
                                <div class="form-group row">
                                    <div class="col-md-5">
                                        <form action="{{ route('validarInscripcion',[$grupo->clave_grupo, $datos->rvoe, $datos->vigencia, $institucion->clave_cct])}}" method="get">
                                            <button data-title="Validar alumnos del Grupo" class="btn btn-outline-success"><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </div>
                                    <div class="col-md-5">
                                        <form id="acuse{{$loop->iteration}}" name="acuse{{$loop->iteration}}" action="{{route('acuseInscripcion',[$grupo->clave_grupo,$datos->rvoe,$institucion->clave_cct,$datos->vigencia])}}" method="get">
