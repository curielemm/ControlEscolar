        ...
        <div class="card card-default">
            ...
            <div class="card-header">
                <div class="text-center">
                    <h4>Seleccione un grupo para ver alumnos no acreditados del grupo</h4>
                </div>
            </div>
                    ...
                    <table class="table table-bordered border-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('alumnosRepro',[encrypt($grupo->clave_grupo),encrypt($datos->rvoe),encrypt($datos->vigencia)])}}">{{$grupo->clave_grupo}}</a></td>
